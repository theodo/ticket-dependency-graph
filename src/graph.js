...
window.myDiagram.nodeTemplate = GO(
  ...
  { isShadowed: true, shadowColor: '#C5C1AA', layoutConditions: go.Part.LayoutAdded },
  {
    mouseDrop(e, node) {
      ...
      if (selnode instanceof go.Node) {
        ...
        node.isLayoutPositioned = true; // eslint-disable-line
      }
    },
  },
  ...
  GO(go.Panel, 'Horizontal',
    ...
    GO(go.TextBlock, {
      margin: 8, font: 'bold 10px sans-serif', width: 100, wrap: go.TextBlock.WrapFit,
    },
...
window.myDiagram.linkTemplate = GO(go.Link,
